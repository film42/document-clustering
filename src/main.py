...
class Main:
    ...
    def assignment_5_875_test(self):
        ...
        count_vectors = [[3, 0], [0, 3], [3, 0], [0, 3], [3, 0]]
        mm = MultinomialMixture(2, count_vectors, n_iterations=4, verbose=True, beta_matrix=beta_matrix, lambda_values=lambda_values)
        mm.learn_parameters()
